...
//   const amount = Number(form.amount); // ✅ dynamic
...
export default function Booking() {
  ...
  /* ✅ BACKGROUND SAVE (FIXED ERROR HERE) */
  const saveBookingInBackground = async (form, paymentId, amount) => {
    try {
      const res = await fetch(`${API}/api/contact`, {
        method: "POST",
        headers: {
    ...
    <section className="booking-container">
      <div className="booking-card">
        ...
        <form onSubmit={handleSubmit}>
          ...
          <textarea name="message" placeholder="Describe problem" onChange={handleChange} />
